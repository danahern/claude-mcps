//! Zephyr Build MCP Server - Main Entry Point
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("Zephyr Build MCP Server started successfully");

    // Wait for the service to complete
    service.waiting().await?;

    info!("Zephyr Build MCP Server stopped");
    Ok(())
}
